...
const AnalyzeComponentInputSchema = z.object({
  ...
  componentCode: z.string().describe('The source code of the UI component to analyze.'),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an expert UI/UX analyst. Analyze the provided UI component code and extract its purpose, user flows, and core UI/UX elements.\n\nComponent Name: {{{componentName}}}\n\nComponent Code:\n\`\`\`\n{{{componentCode}}}\n\`\`\`\n\nProvide a detailed analysis, focusing on:
- The primary purpose of the component based on its code.
- Typical user flows this component would be part of.
- A comprehensive list of core UI/UX elements and functionality implemented in the code.
