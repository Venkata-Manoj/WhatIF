...
import { Lightbulb, ShieldAlert, Wrench, Cpu, FileSearch, ClipboardCheck, AlertTriangle } from 'lucide-react';
      ...
      <div className="flex flex-col items-center text-center p-4 w-full">
        ...
        >
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-10 text-left">
              <div className="flex flex-col p-6 bg-card/30 rounded-lg shadow-lg">
                <div className="flex items-center gap-3 mb-4">
                  <Cpu className="h-10 w-10 text-primary" />
                  <h3 className="text-xl font-semibold">Underlying Technology</h3>
                </div>
                <p className="text-muted-foreground">
                  WhatIF leverages a powerful combination of Large Language Models (LLMs) and static code analysis principles. By analyzing the code's structure and semantics, it provides insights that go beyond simple linting.
                </p>
              </div>
              <div className="flex flex-col p-6 bg-card/30 rounded-lg shadow-lg">
                 <div className="flex items-center gap-3 mb-4">
                  <FileSearch className="h-10 w-10 text-primary" />
                  <h3 className="text-xl font-semibold">Analysis Methodology</h3>
                </div>
                <p className="text-muted-foreground">
                  The AI identifies common patterns and anti-patterns, simulates user flows, and cross-references your code against a vast knowledge base of best practices to identify potential risks and generate actionable suggestions.
                </p>
              </div>
              <div className="flex flex-col p-6 bg-card/30 rounded-lg shadow-lg">
                 <div className="flex items-center gap-3 mb-4">
                  <ClipboardCheck className="h-10 w-10 text-primary" />
                  <h3 className="text-xl font-semibold">Types of Analysis Performed</h3>
                </div>
                <p className="text-muted-foreground">
                 The analysis focuses on key areas critical for modern web applications: Accessibility (A11Y), Performance, UI/UX Best Practices, and potential Functional issues to ensure a robust and user-friendly experience.
                </p>
              </div>
              <div className="flex flex-col p-6 bg-card/30 rounded-lg shadow-lg">
                 <div className="flex items-center gap-3 mb-4">
                  <AlertTriangle className="h-10 w-10 text-primary" />
                  <h3 className="text-xl font-semibold">Limitations & Disclaimers</h3>
                </div>
                <p className="text-muted-foreground">
                  WhatIF is an AI-assisted tool, not a definitive authority. Its suggestions should be reviewed by a human developer. The analysis may contain inaccuracies and is intended to augment, not replace, your professional judgment.
                </p>
              </div>
          </div>
        </motion.div>
